...
create table login (cd_login int primary key not null, nm_email varchar(50) not null , ds_senha varchar(20) not null, cd_usuario int foreign key);
create table usuario (cd_usuario int primary key not null, nm_usuario varchar(25), ds_cep varchar(9), dt_nascimento date, cd_tipo int, ds_moradia varchar(5), nm_instituicao varchar(30), ds_comprovante varchar(30));
